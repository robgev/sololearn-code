...
module.exports = {
  ...
  module: {
    ...
    rules: [
      ...
      /* Start: Turn off breaking eslint */
      // {
      //   test: /\.(js|jsx|mjs)$/,
      //   enforce: 'pre',
      //   use: [
