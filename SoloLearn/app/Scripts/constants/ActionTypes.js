...
// Playground types
export const GET_CODES = 'LOAD_CODES';
export const EMPTY_CODES = 'EMPTY_CODES';

// Discuss types
export const GET_QUESTIONS = 'LOAD_QUESTIONS';
...
export const GET_PROFILE_CODES = 'LOAD_PROFILE_CODES';
export const GET_PROFILE_QUESTIONS = 'LOAD_PROFILE_QUESTIONS';
