...
class Editor extends Component {
    ...
    loadEditor = () => {
        ...
        let editorMode = "ace/mode/" + mode;
        let editorTheme = "ace/theme/" + theme;
    ...
    render() {
        return (
            <div>
                {aceEditorStyle}
                {aceLineStyle}
                <div id="editor" ref="editor" style={true ? styles.editor.base : getStyles(styles.editor.base, styles.editor.hide)}></div>
            </div>
        );
    }
