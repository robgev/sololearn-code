...
class Codes extends Component {
    ...
    loadCodes() {
        ...
        this.props.getCodes(index, ordering, language, query, userId).then(count => {
    ...
    renderCodes() {
        return this.props.codes.map((code, index) => {
            return (
