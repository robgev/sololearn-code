...
class Comments extends Component {
    ...
    loadComments = (parentId) => {
        ...
        if (parentId) {
            ...
            let activeComment = comments[commentIndex];
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({
        ...
        emptyCommentReplies: emptyCommentReplies,
        voteCommentInternal: voteCommentInternal,
        editCommentInternal: editCommentInternal
    }, dispatch);
}

export default connect(() => { return {} }, mapDispatchToProps,  null, { withRef: true })(Radium(Comments));