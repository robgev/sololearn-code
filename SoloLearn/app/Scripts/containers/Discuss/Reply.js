        ...
        if(!this.state.isEditing) {
            ...
            return (
                [<div key={"editor" + reply.id} style={styles.editor}>
                    <TextField key={"replyTextField" + reply.id} hintText="Message" multiLine={true} maxLength="2048" rowsMax={4} fullWidth={true} defaultValue={this.state.textFieldValue}  
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({ 
        editPostInternal: editPostInternal,
        toggleAcceptedAnswerInternal: toggleAcceptedAnswerInternal
    }, dispatch);
}

export default connect(() => { return {} }, mapDispatchToProps)(Radium(Reply));